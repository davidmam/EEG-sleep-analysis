...
if __name__ == "__main__":
    ...
    parser.add_argument('-refDir', help='Analysis directory', default='.')
    parser.add_argument('-normFlag', help='Use probabilities instead of counts: 1 for yes, 0 for no.', default=0)
